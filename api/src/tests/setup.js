...
beforeAll(async () => {
  ...
  // Cache service disabled in tests
  logger.info('Cache service disabled for tests');
...
afterAll(async () => {
  ...
  // Cache service disabled - no cleanup needed
...
beforeEach(async () => {
  // Cache service disabled - no cache to clear
});
